...
import com.eMart.persistence.entity.Purchasehistory;
import com.eMart.persistence.service.PurchasehistoryService;

@RestController
@RequestMapping("/purchasehistory")
public class RestControllerPurchasehistory {
	...
	public Purchasehistory save (@RequestBody Purchasehistory o) {
		return (Purchasehistory) getService().save(o);
	}
